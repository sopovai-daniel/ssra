...
| # | položka | kedy |
|---|---|---|
| 1 | **Doplniť konzolovú fakturovanú sumu** re-kalibrácie do ledgera + D-logu (billing 60-min lag; CC odhad $1.30 ≈ 1.14 EUR; konzola autoritatívna) | hneď ako ju konzola ukáže |
