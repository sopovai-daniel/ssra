...
| M2-phase0-cpu-smoke | 2026-06-14 | `experiments/M2-phase0-cpu-smoke.yaml` | SSRA P1, tokenized path | 2.65M params, FineWeb-Edu BPE-16k, 60×4×256 tok | MacBook M1, CPU fp32 | QUEUED | functionality only (no quality conclusion) | `logs/M2-phase0-cpu-smoke.log` | Phase-0 harness smoke: exercises token shards + AP-11 checkpoint/resume; corpus FineWeb-Edu sample-10BT (odc-by, sha 87f09149), tokenizer sha256 019568a2 |
