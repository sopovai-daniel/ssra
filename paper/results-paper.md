...
**Status:** DRAFT v0.5, 2026-07-18 — B4 reviewer pass executed (all numbers cross-checked against source reports and raw records; [src] tags resolved and stripped; ref [29] completed); publication gate verdict pending (author); do not cite.
